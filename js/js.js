...
class Hamburger {
	constructor(logo, hamburgerIcon, linksList, linksItem, inactive) {
		this.logo = logo;
	...
	create() {
		this.hamburgerIcon.addEventListener('click', () => {
			if(this.linksList.classList.contains('active')) {
				this.closeMenu(this.logo, this.hamburgerIcon, this.linksList, this.inactive);
			} else {
				this.openMenu(this.logo, this.hamburgerIcon, this.linksList, this.linksItem, this.inactive);
			}
		});
	}
	
	openMenu(logo, hamburgerIcon, linksList, linksItem,inactive) {
	...
	closeMenu(logo, hamburgerIcon, linksList, inactive) {
...
window.addEventListener('DOMContentLoaded', function() {
	...
	new Hamburger(menuLogo, menuHamburger, menuList, menuItem, inactive).create();
})	
;
/**
 * Swiper 6.3.5
